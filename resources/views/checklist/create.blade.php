...
@section('title', 'Nuevo ítem de Checklist')

@section('content')
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Nuevo ítem de checklist</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Se mostrará en mantenimientos del tipo indicado (o en todos si no se indica)</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <form action="{{ route('checklist.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="inline-flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Obligatorio (debe marcarse antes de completar el mantenimiento)</span>
                    </label>
                </div>
            </div>
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <button type="submit" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white rounded-lg">Crear ítem</button>
            </div>
        </form>
    </div>
</div>
